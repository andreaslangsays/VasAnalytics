...
class Repository extends ModelRepository
{
    ...
    /**
     * Returns an instance of the \Doctrine\ORM\Query object which selects a list of Statistics
     *
     * @param null $filter
     * @param null $orderBy
     * @param      $offset
    ...
    public function getListQueryBuilder($filter = null, $orderBy = null)
    {
        ...
        $builder->select(array('statistics'))
            ->from($this->getEntityName(), 'statistics');
